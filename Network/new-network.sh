...
export FABRIC_CFG_PATH=${PWD}/configtx/new-config
...
function createOrgs() {
  ...
  if [ "$CRYPTO" == "Certificate Authorities" ]; then
    ...
    . organizations/fabric-ca/new-registerEnroll.sh
  ...
  infoln "Generate CCP files for Org1 , Org2 , Org3 , Org4 and Org5"
  ./organizations/new-ccp-generate.sh
}
...
COMPOSE_FILE_BASE=docker/new-docker-compose-test-net.yaml
# docker-compose.yaml file if you are using couchdb
COMPOSE_FILE_COUCH=docker/new-docker-compose-couch.yaml
# certificate authorities compose file
COMPOSE_FILE_CA=docker/new-docker-compose-ca.yaml
#
